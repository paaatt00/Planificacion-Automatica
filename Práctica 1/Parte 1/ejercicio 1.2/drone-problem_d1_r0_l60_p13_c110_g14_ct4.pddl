(define (problem drone-problem_d1_r0_l60_p13_c110_g14_ct4)
(:domain drone-dom)
(:objects
	drone1 - drone
	warehouse - location
...
(:goal (and
	...
	(human-has human12 clothes)
	(human-has human13 clothes)
	))
)
